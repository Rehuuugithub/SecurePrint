        ...
        <section className="w-full max-w-md mx-auto px-6 py-6">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
            ...
            <button
               ...
               className={`w-full py-4 rounded-xl text-sm font-bold tracking-wider uppercase transition-all duration-300 ${
                 files.length === 0 || pairingCode.length !== 6 
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                <div>
                  ...
                  <a href="mailto:rihan734002@gmail.com" className="text-xs text-slate-400 hover:text-white transition-colors">rihan734002@gmail.com</a>
                </div>
                <div>
